...
class userProfile extends Component {
		...
		Meteor.call("getUserDetails", options, function(err, response) {
			...
			if(response)
			{
				...
				this.setState({
                    ...
                    dob: ((response.profile.dob !== "" && response.profile.dob !== undefined) ? response.profile.dob : (response.profile.dob !== "" && response.profile.dob !== undefined) ? response.profile.dob : '')
    ...
    validateForm() 
	{
		...
		this.setState({
			...
			formValid: this.state.nameValid && this.state.phoneValid && this.state.passwordValid && this.state.passwordConfirmationValid
                    ...
                    <form onSubmit={this.onSubmit}>
                        ...
                        <div className="overlay-pop-up">
                            ...
                            <div className="overlay-pop-up-header">
                                ...
                                <h1 className="pop-up-title"> My Profile </h1>
